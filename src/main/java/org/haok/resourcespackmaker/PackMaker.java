...
public class PackMaker {
    private static final LogPrintStream logger = LogFactory.getLogger(PackMaker.class);
    public static void makePack(boolean isZip) throws Exception {
        ...
        logger.println("make pack directory:" + packPath.mkdirs());
        logger.println("make pack.mcmeta:" + pack_mcmeta.createNewFile());
        ...
        if (!(ttfFile == null)) {
            ...
            logger.println("make font directory"+fontPath.mkdirs());
            ...
            logger.println("make font json file:" + jsonFile.createNewFile());
            BufferedWriter jsonWriter = new BufferedWriter(new FileWriter(jsonFile));
            {
                ...
                object.put("prividers",providers);
                String json = object.toJSONString();
            ...
            if (panorama0 != null) {
                ...
                logger.println("make panorama directory:" + panoramaPath.mkdirs());
